...
public class Calculator {
	...
	private void initialize() {
		...
		lblScientificCalculator.setForeground(new Color(153, 153, 255));
		lblScientificCalculator.setFont(new Font("Tahoma", Font.BOLD, 22));
		...
		btnRev.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		btnB.setFont(new Font("Wingdings", Font.PLAIN, 18));
